...
def analyze_proxy_features(organization):
    ...
    if organization.proxy_data.baseline_working < 80 and organization.proxy_data.peak_login_percentage < organization.proxy_data.baseline_working:
        confidence_masure_1 = "High"
    elif organization.proxy_data.baseline_working < 90 and organization.proxy_data.peak_login_percentage < organization.proxy_data.baseline_working:
        confidence_masure_1 = "Medium"
    else: 
        confidence_masure_1 = "Low"
    ...
    if organization.proxy_data.meeting_density > 0.3 and confidence_masure_1 == "High":
        confidence_measure_2 = "High"
    elif organization.proxy_data.meeting_density > 0.3 and confidence_masure_1 == "Medium":
    ...
    print(f" we can estimate that real estate reduction by a similar factor is achievable.\n")
    print(f"Factoring systemic absences there is a {confidence_masure_1} confidence that real estate reduction is \n")

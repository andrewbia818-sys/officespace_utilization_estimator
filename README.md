# officespace_utilization_estimator
...
The project uses simple math on organizational data and produce utilization estimates, and confidence scores, that can support workplace planning and real estate decision-making.
...
* Uses simple math to estimate workspace utilization
* Produces:
...
```bash
git clone https://github.com/YOUR_USERNAME/officespace-utilization-estimator.git
```

Navigate to the project directory:

```bash
cd officespace-utilization-estimator
```
